function Get-ArubaOSDot1xSupplicantPort
{
...
   )
    ...
    Invoke-RestMethod -Method Get -Uri https://$Switch/rest/v1/dot1x/supplicant/$Port -DisableKeepAlive -Headers @{"cookie"="$ArubaOSCookie"}
}