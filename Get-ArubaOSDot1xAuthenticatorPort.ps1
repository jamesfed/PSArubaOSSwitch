function Get-ArubaOSDot1xAuthenticatorPort
{
...
   )
    ...
    Invoke-RestMethod -Method Get -Uri https://$Switch/rest/v1/dot1x/authenticator/$Port -DisableKeepAlive -Headers @{"cookie"="$ArubaOSCookie"}
}
